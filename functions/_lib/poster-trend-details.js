const STUDIOS = new Map([
  ['A24', 'A24 Movie'],
  ['Pixar Animation Studios', 'Pixar Movie'],
  ['Pixar', 'Pixar Movie'],
  ['Studio Ghibli', 'Studio Ghibli Movie'],
  ['Blumhouse Productions', 'Blumhouse'],
  ['NEON', 'NEON Movie'],
  ['Neon', 'NEON Movie'],
  ['Searchlight Pictures', 'Searchlight Movie'],
  ['BBC Film', 'BBC Movie'],
  ['BBC Films', 'BBC Movie'],
  ['Bad Robot', 'Bad Robot'],
  ['Bad Robot Productions', 'Bad Robot'],
  ['HBO', 'HBO Original'],
  ['Laika Entertainment', 'LAIKA Movie'],
  ['Laika', 'LAIKA Movie'],
]);

const DIRECTORS = new Map([
  ['Christopher Nolan', 'Nolan Movie'],
  ['Denis Villeneuve', 'Villeneuve Movie'],
  ['Martin Scorsese', 'Scorsese Movie'],
  ['Wes Anderson', 'Wes Anderson Movie'],
  ['Sofia Coppola', 'Sofia Coppola Movie'],
  ['Bong Joon-ho', 'Bong Joon-ho Movie'],
  ['Hayao Miyazaki', 'Miyazaki Movie'],
  ['David Fincher', 'Fincher Movie'],
  ['Paul Thomas Anderson', 'P.T. Anderson Movie'],
  ['Quentin Tarantino', 'Tarantino Movie'],
  ['Alfonso Cuarón', 'Alfonso Cuarón Film'],
  ['Guillermo del Toro', 'Guillermo del Toro Film'],
  ['Ridley Scott', 'Ridley Scott Film'],
  ['Steven Spielberg', 'Spielberg Movie'],
  ...
  ['Stanley Kubrick', 'Kubrick Movie'],
  ['Spike Lee', 'Spike Lee Film'],
  ['David Cronenberg', 'Cronenberg Movie'],
...
export function chooseTrendDisplay({
  ...
  if (selected.has('rank') && rank) return { label: 'Trending', source: 'rank' };
